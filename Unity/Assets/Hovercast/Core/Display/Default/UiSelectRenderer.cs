...
namespace Hovercast.Core.Display.Default {
	...
	public class UiSelectRenderer : MonoBehaviour, IUiArcSegmentRenderer {
		...
		public virtual void Build(ArcState pArcState, ArcSegmentState pSegState,
			...
			vBackground.GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Unlit/AlphaSelfIllum"));
			vBackground.GetComponent<Renderer>().sharedMaterial.renderQueue -= 300;
			vBackground.GetComponent<Renderer>().sharedMaterial.color = Color.clear;
			...
			vEdge.GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Unlit/AlphaSelfIllum"));
			vEdge.GetComponent<Renderer>().sharedMaterial.renderQueue -= 300;
			vEdge.GetComponent<Renderer>().sharedMaterial.color = Color.clear;
			...
			vHighlight.GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Unlit/AlphaSelfIllum"));
			vHighlight.GetComponent<Renderer>().sharedMaterial.renderQueue -= 200;
			vHighlight.GetComponent<Renderer>().sharedMaterial.color = Color.clear;
			...
			vSelect.GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Unlit/AlphaSelfIllum"));
			vSelect.GetComponent<Renderer>().sharedMaterial.renderQueue -= 10;
			vSelect.GetComponent<Renderer>().sharedMaterial.color = Color.clear;
		...
		public virtual void Update() {
			...
			vBackground.GetComponent<Renderer>().sharedMaterial.color = colBg;
			vEdge.GetComponent<Renderer>().sharedMaterial.color = colEdge;
			vHighlight.GetComponent<Renderer>().sharedMaterial.color = colHigh;
			vSelect.GetComponent<Renderer>().sharedMaterial.color = colSel;
