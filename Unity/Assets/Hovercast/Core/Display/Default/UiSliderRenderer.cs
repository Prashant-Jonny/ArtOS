...
namespace Hovercast.Core.Display.Default {
	...
	public class UiSliderRenderer : MonoBehaviour, IUiArcSegmentRenderer {
		...
		public virtual void Build(ArcState pArcState, ArcSegmentState pSegState,
			...
			vTrack.GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Unlit/AlphaSelfIllum"));
			vTrack.GetComponent<Renderer>().sharedMaterial.renderQueue -= 600;
			vTrack.GetComponent<Renderer>().sharedMaterial.color = Color.clear;
			...
			vFill.GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Unlit/AlphaSelfIllum"));
			vFill.GetComponent<Renderer>().sharedMaterial.renderQueue -= 500;
			vFill.GetComponent<Renderer>().sharedMaterial.color = Color.clear;
			...
			if ( vNavSlider.Ticks > 1 ) {
				...
				for ( int i = 0 ; i < vNavSlider.Ticks ; ++i ) {
					...
					quad.GetComponent<Renderer>().sharedMaterial = vTickMat;
		...
		public virtual void Update() {
			...
			vTrack.GetComponent<Renderer>().sharedMaterial.color = colTrack;
			vFill.GetComponent<Renderer>().sharedMaterial.color = colFill;
